## Section-5 Single beat without waveform: AXI Lite
- This section covers topics such as different AXI Configurations, single beat without pipeline and implementation of master and slave FSM along with the concept of timeout.

## Different AXI Configurations
- 1) Single beat without pipeline
  2) Single beat with pipeline
  3) Burst without pipeline
  4) Burst with pipeline
